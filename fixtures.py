"""Fixtures fictives — porté depuis data.js. Rien de réel."""
...
CLAIM_TYPES = ["Collision", "Véhicule immobilisé", "Vol", "Bris de glace"]
CITIES = ["Casablanca", "Rabat", "Marrakech", "Autre"]
DOC_TYPES = ["Photo du véhicule", "Constat", "Procès-verbal", "Autre"]
AI_PURPOSES = ["Demander une pièce manquante", "Confirmer la prise en charge du dossier", "Proposer un rappel humain"]
STATUSES = ["À qualifier", "En revue", "En attente client", "Escalade humaine", "Clos"]
